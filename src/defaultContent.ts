export const DEFAULT_CONTENT: Record<string, any> = {
  nav: {
    tagline: 'Premium Hand-Coded Web Design',
    cta: 'Get Free Demo',
    links: [
  ...
  process: {
    eyebrow: 'How We Work',
    headline: 'From Concept to Launch in 48 Hours',
    subheadline: 'A rapid, transparent engineering process with zero hidden friction.',
    steps: [
      { title: '1. Discovery & Concept', description: 'Share your business goals, target audience, and preferred design style over WhatsApp or call.' },
      { title: '2. 48-Hour Working Demo', description: 'We hand-code your live prototype and deploy it on a private preview link for your evaluation.' },
      { title: '3. Precision Refinement', description: 'We polish layouts, refine copy, and optimize mobile responsive views based on your exact feedback.' },
      { title: '4. Approval & Launch', description: 'You approve the final product, pay securely, and we connect your custom domain with global SSL.' },
    ],
  },
  pricing: {
    eyebrow: 'Transparent Pricing',
    headline: 'High-Performance Web Packages',
    subheadline: 'Simple, honest pricing. Pay only after you review and approve your working demo.',
    note: 'All packages come with Demo-First guarantee, SSL certificate, mobile optimization, and full code delivery.',
    ...
    plans: [
      {
        ...
        currency: '₹',
        period: 'one-time',
        description: 'Ideal for local private schools, clinics, restaurants, and retail shops getting a professional digital identity.',
        featured: false,
      ...
      },
      {
        ...
        currency: '₹',
        period: 'one-time',
        description: 'Engineered for colleges, multi-specialty hospitals, luxury resorts, and expanding commercial brands.',
        featured: true,
        ...
        features: [
          ...
          'Automated inquiry & lead funnel',
          'Hyper-local Google Maps dominance setup',
          'Interactive media galleries & notices',
          'n8n CRM / WhatsApp instant alert workflow',
          '3 months priority maintenance & support',
          'Full code ownership & Git repository',
        ],
      },
      {
        subtitle: 'Custom Digital Suite',
        name: 'Scale',
        price: '24,999',
        currency: '₹',
        period: 'one-time',
        description: 'Full custom digital ecosystem for institutions, startup brands, and high-volume businesses.',
        featured: false,
        interest: 'Scale Plan',
        cta: 'Request Scale Demo',
        features: [
          'Unlimited custom hand-coded pages',
          'Custom web applications & interactive portals',
          'End-to-end SEO & content positioning',
          'Social media viral engineering setup',
          'Custom AI auto-responder integration',
          '6 months dedicated developer partnership',
